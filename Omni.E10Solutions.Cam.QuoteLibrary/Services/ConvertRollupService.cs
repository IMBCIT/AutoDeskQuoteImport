...
{
    class ConvertRollupService : IConvertJobsToQuotesService
    {
        Epicor10 _epicor;
        Epicor10Cache _cache;

        public ConvertRollupService(Epicor10 epicor, Epicor10Cache cache)
        {
            _epicor = epicor;
            _cache = cache;
        }
        ...
        public List<IQuote> Convert(CamductJobCollection jobs)
        {
            ...
            var quoteFactory = new RolledUpQuoteFactory(_cache, udService);
